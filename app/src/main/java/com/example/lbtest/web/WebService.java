...
public class WebService {
    ...
    public static String executeHttpGet2(String url,Integer id,String date, String first,String dbas ,String shps) {
        HttpURLConnection conn = null;
        InputStream is = null;
        try {
            // 用户名 密码
            // URL 地址
            String path = "http://" + IP + "/HelloWeb/";
            path = path + url + "?id=" + id+"&date="+date+"&first="+first+"&dbas="+dbas+"&shps=" + shps +"&shps=";
